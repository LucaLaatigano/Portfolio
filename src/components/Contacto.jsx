...
export default function Contacto({ id }) {
    ...
    const sendEmail = (e) => {
        ...
        const templateParams = {
            name: name,
            email: metodo === "wapp" ? "Contacto vía WhatsApp" : email,
            asunto: asunto,
            msg: msg
        };
            ...
            <div className="flex flex-col gap-10">
                ...
                <div className="flex gap-3 w-auto justify-start">
                    <button
                        ...
                        className={`flex gap-2 justify-center py-2 px-5 w-35 h-10 border border-hint/30 ${metodo === "email" ? "bg-hint/20" : ""} text-muted text-center rounded-xl transition-all`}
                    >
                    ...
                    <button
                        ...
                        className={`flex gap-2 justify-center py-2 px-5 w-35 h-10 border border-hint/30 ${metodo === "wapp" ? "bg-hint/20" : ""} text-muted text-center rounded-xl transition-all`}
                    >
                        WhatsApp <FaWhatsapp className="size-4 text-muted mt-1" />
                    </button>
                </div>
                <form onSubmit={sendEmail} className="flex flex-col justify-center w-full">
